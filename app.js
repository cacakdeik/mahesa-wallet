...
// ═══════════════════════════════════
// PAGE LOADER (fetch HTML fragments)
// ═══════════════════════════════════
const PAGE_MAP = {
  'home':               'home.html',
  'strategiPage':       'strategi.html',
  'statistik':          'statistik.html',
  'tabunganPage':       'dompet.html',
  'bpjsPage':           'dompet.html',
  'maybankPage':        'dompet.html',
  'gajiPage':           'dompet.html',
  'riwayat':            'riwayat.html',
  'setting':            'setting.html',
  'kencanPage':         'kencan.html',
  'simulasiHutangPage': 'simulasi_hutang.html',
  'catatanAnakPage':    'catatan_anak.html',
};

const loadedFiles = new Set(); // track file yang sudah di-inject

async function loadPageFile(pageId) {
  ...
  try {
    ...
    document.getElementById('pageContainer').insertAdjacentHTML('beforeend', html);
...
async function showPage(id) {
  // Load file dulu kalau belum ada
  await loadPageFile(id);
...
async function initApp() {
  // Load halaman pertama (home) dulu sebelum render
  await loadPageFile('home');
